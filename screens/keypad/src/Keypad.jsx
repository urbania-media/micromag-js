...
const KeypadScreen = ({
    ...
    const [screenState, setScreenState] = useState('keypad');
        ...
        >
            ...
            <Container width={width} height={height} className={styles.inner}>
                <Scroll
                    ...
                    height={height}
                    // withShadow
                    disabled={isPreview || isPlaceholder || isEdit || screenState === 'popup'}
                    // disabled
                >
                    <Layout

...
function fields() {
    ...
    return [
            ...
            fields: [
                {
                    name: 'description',
                    label: (
                        <FormattedMessage defaultMessage="Description" description="Field name" />
                    ),
                    type: 'text',
                    component: 'text',
                },
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    id: 'created_at',
                    label: (
                        <FormattedMessage defaultMessage="Created at" description="Field label" />
                    ),
                    type: 'display',
                    display: 'date',
                    name: 'created_at',
        ...
        },
        {
            ...
            component: 'fields',
            label: (
                <FormattedMessage defaultMessage="Technical details" description="Field title" />
            ),
            isList: true,
            hideWithoutValue: true,
            fields: [
                ...
                },
                {
                    id: 'dimensions',
                    label: (
                        <FormattedMessage defaultMessage="Dimensions" description="Field label" />
                    ),
                    type: 'display',
                    display: 'unit',
                    format: 'dimensions',

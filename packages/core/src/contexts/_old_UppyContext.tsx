...
interface UppyProviderProps {
    ...
    transport?: 'xhr' | 'transloadit' | 'tus';
    locale?: string;
    sources?: ('webcam' | 'facebook' | 'instagram' | 'dropbox' | 'google-drive')[];
    transloadit?: { key: string; templateId?: string; waitForEncoding?: boolean };
    companion?: { url: string; allowedHosts: string };
    tus?: string | { endpoint: string };

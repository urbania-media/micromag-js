...
export { default as SlidingButtons } from './buttons/SlidingButtons';
...
export { default as Close } from './partials/Close';
...
export { default as ScreenSizer } from './screens/ScreenSizer';

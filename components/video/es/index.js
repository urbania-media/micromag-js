...
var VideoControls = function VideoControls(_ref) {
  ...
  var onClickPlayPause = useCallback(function () {
  ...
  var onClickMute = useCallback(function () {
  ...
  }, playbackVisible ? React.createElement("button", {
    type: "button",
    className: styles.button,
    onClick: onClickPlayPause,
    style: _objectSpread({}, getStyleFromColor(playbackColor, 'color'))
  }, React.createElement(FontAwesomeIcon, {
    icon: playing ? faPause : faPlay,
    className: styles.icon
  })) : null, React.createElement("div", {
    className: styles.spacer
  }, progressVisible ? React.createElement("div", {
    className: classNames(['progress', styles.progress]),
    style: _objectSpread({}, getStyleFromColor(progressColor, 'borderColor', 0.3))
  }, React.createElement("div", {
  ...
  })) : null), volumeVisible ? React.createElement("button", {
    type: "button",
    className: styles.button,
    onClick: onClickMute,
    style: _objectSpread({}, getStyleFromColor(volumeColor, 'color'))
  }, React.createElement(FontAwesomeIcon, {
...
var Video = function Video(_ref) {
  ...
  var onPlayerReady = useCallback(function () {
    setPlayerReady(true);
    setDuration(refPlayer.current.duration());
    setVideoSize(refPlayer.current.size());
  }, [setPlayerReady, setDuration, setVideoSize]);
  var onPlayerStateChange = useCallback(function (newPlayerState) {
    setPlayerState(newPlayerState);
  }, [setPlayerState]);
  var onPlayerCurrentTimeChange = useCallback(function (newCurrentTime) {
    setCurrentTime(newCurrentTime);
  }, [setCurrentTime]);

  var _ref2 = fit || {},
      _ref2$size = _ref2.size,
      size = _ref2$size === void 0 ? 'fit' : _ref2$size;

  var playerSize = size === 'fit' ? {
    width: width,
    height: height
  ...
  }, PlayerComponent !== null ? React.createElement("div", {
  ...
  })) : null, playerReady ? React.createElement(VideoControls, Object.assign({}, refPlayer.current, playerState, controls, {
    duration: duration,
...
var useYouTubeVideoSize = function useYouTubeVideoSize(videoId) {
  ...
  var googleApiClient = useGoogleApiClient();
...
var Poster = function Poster(_ref) {
  ...
  return PosterComponent !== null ? React.createElement(PosterComponent, {
    url: url,
    width: width,
    height: height,
...
var VideoYouTube = function VideoYouTube(_ref) {
  ...
  var videoId = getYouTubeVideoId(url);
  var refIframe = useRef(null);
  var refPlayer = useRef(null);
  var refVideoId = useRef(videoId); // Get video size
  ...
  var updatePlayerState = useCallback(function (newPlayerState) {
    setPlayerState(newPlayerState);
  ...
  var _useState3 = useState(typeof YT !== 'undefined'),
      _useState4 = _slicedToArray(_useState3, 2),
      loaded = _useState4[0],
  ...
  var playerApi = useMemo(function () {
  ...
  return React.createElement("div", {
    ...
    onClick: onClickPlayPause
  }), React.createElement(PosterYouTube, {
    url: url,
...
export { VideoControls as Controls, Poster, PosterYouTube, Video, VideoYouTube };

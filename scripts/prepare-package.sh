...
build_types() {
    ...
    ../../node_modules/.bin/tsc "${unique_ts_entries[@]}" --ignoreConfig --declaration --emitDeclarationOnly --jsx "react-jsx" --declarationDir "types" --listEmittedFiles --noCheck
